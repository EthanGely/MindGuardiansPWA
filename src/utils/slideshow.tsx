      ...
      <div className="slide-show">
            ...
            >
              <div className="content">
                ...
                {index === slides.slides.length - 1 ? (
                  ...
                  <button className="button button--secondary u-align-center" onClick={() => nextSlide()}>
                    {slide.buttonLabel}
                  </button>
                )}
              </div>
        ...
        <div className="dots">
          {slides.slides.map((_: any, index: number) => (
            <span key={index} className={index === currentSlide ? "dot active" : "dot"} onClick={() => goToSlide(index)}></span>
          ))}
        </div>
      </div>
    </>
